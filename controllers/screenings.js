...
const updateReservation = async (req, res, next) => {
    ...
    try {
        await sendEmail({
        ...
        }, "Modyfikacja miejsc w seansie", null, null, `<!doctype html>\n` +
            ...
            "                                        Pomyślnie zaktualizowaliśmy miejsca, które zajmiesz na seansie.\n" +
            "                                    </div>\n" +
            "                                    <div class=\"movie\"\n" +
            ...
            "\n" +
            "                                                <img height=\"auto\" src=\"https://vps.miloszkotarba.pl/~vue/successIMG.png\"\n" +
